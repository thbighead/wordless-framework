...
trait Between
{
     ...
     * @throws InvalidYear
     */
    public function whereYearBetween(int $start, int $end): static
    {
        $this->arguments[] = [
     ...
     * @throws InvalidMonth
     */
    public function whereMonthOfYearBetween(int $start, int $end): static
    {
        $this->arguments[] = [
            'compare' => Compare::between->value,
            self::KEY_MONTH => [
     ...
     * @throws InvalidWeek
     */
    public function whereWeekOfYearBetween(int $start, int $end): static
    {
        $this->arguments[] = [
            'compare' => Compare::between->value,
     ...
     * @throws InvalidWeek
     */
    public function whereDayOfYearBetween(int $start, int $end): static
    {
        $this->arguments[] = [
            'compare' => Compare::between->value,
     ...
     */
    public function whereDayOfMonthBetween(int $start, int $end): static
    {
        $this->arguments[] = [
            'compare' => Compare::between->value,
     ...
     */
    public function whereDayOfWeekBetween(int $start, int $end): static
    {
        $this->arguments[] = [
            'compare' => Compare::between->value,
     ...
     * @throws InvalidDayOfWeek
     */
    public function whereDayOfWeekIsoBetween(int $start, int $end): static
    {
        $this->arguments[] = [
            'compare' => Compare::between->value,
     ...
     * @throws InvalidHour
     */
    public function whereHourOfDayBetween(int $start, int $end): static
    {
        $this->arguments[] = [
            'compare' => Compare::between->value,
            self::KEY_HOUR => [
     ...
     */
    public function whereMinuteOfHourBetween(int $start, int $end): static
    {
        $this->arguments[] = [
            'compare' => Compare::between->value,
            self::KEY_MINUTE => [
     ...
     */
    public function whereSecondOfMinuteBetween(int $start, int $end): static
    {
        $this->arguments[] = [
            'compare' => Compare::between->value,
            self::KEY_SECOND => [
     ...
     */
    public function whereYearMonthBetween(int $start, int $end): static
    {
        $this->arguments[] = [
            'compare' => Compare::between->value,
